...
const browserlist = [
  ...
  ...createConfig('collections', 'binary_heap.js', 'binary_heap', 'collections.binary_heap'),
  ...
  ...createConfig('collections', 'drop_last_while.js', 'drop_last_while', 'collections.drop_last_while'),
  ...createConfig('collections', 'drop_while.js', 'drop_while', 'collections.drop_while'),
  ...
  ...createConfig('collections', 'includes_value.js', 'includes_value', 'collections.includes_value'),
  ...createConfig('collections', 'intersect.js', 'intersect', 'collections.intersect'),
  ...createConfig('collections', 'join_to_string.js', 'join_to_string', 'collections.join_to_string'),
  ...
  ...createConfig('collections', 'max_by.js', 'max_by', 'collections.max_by'),
  ...createConfig('collections', 'max_of.js', 'max_of', 'collections.max_of'),
  ...createConfig('collections', 'min_of.js', 'min_of', 'collections.min_of'),
  ...createConfig('collections', 'min_with.js', 'min_with', 'collections.min_with'),
  ...
  ...createConfig('collections', 'reduce_groups.js', 'reduce_groups', 'collections.reduce_groups'),
  ...createConfig('collections', 'running_reduce.js', 'running_reduce', 'collections.running_reduce'),
  ...createConfig('collections', 'sample.js', 'sample', 'collections.sample'),
  ...createConfig('collections', 'sliding_windows.js', 'sliding_windows', 'collections.sliding_windows'),
  ...
  ...createConfig('collections', 'take_last_while.js', 'take_last_while', 'collections.take_last_while'),
  ...createConfig('collections', 'take_while.js', 'take_while', 'collections.take_while'),
  ...createConfig('collections', 'union.js', 'union', 'collections.union'),
  ...createConfig('collections', 'unzip.js', 'unzip', 'collections.unzip'),
  ...createConfig('collections', 'without_all.js', 'without_all', 'collections.without_all'),
...
function extractApis () {
  ...
  extractApi('collections', 'binary_heap', 'binary_heap', 'collections.binary_heap'),
  ...
  extractApi('collections', 'drop_last_while', 'drop_last_while', 'collections.drop_last_while'),
  extractApi('collections', 'drop_while', 'drop_while', 'collections.drop_while'),
  ...
  extractApi('collections', 'includes_value', 'includes_value', 'collections.includes_value'),
  extractApi('collections', 'intersect', 'intersect', 'collections.intersect'),
  extractApi('collections', 'join_to_string', 'join_to_string', 'collections.join_to_string'),
  ...
  extractApi('collections', 'max_by', 'max_by', 'collections.max_by'),
  extractApi('collections', 'max_of', 'max_of', 'collections.max_of'),
  extractApi('collections', 'min_of', 'min_of', 'collections.min_of'),
  extractApi('collections', 'min_with', 'min_with', 'collections.min_with'),
  ...
  extractApi('collections', 'reduce_groups', 'reduce_groups', 'collections.reduce_groups'),
  extractApi('collections', 'running_reduce', 'running_reduce', 'collections.running_reduce'),
  extractApi('collections', 'sample', 'sample', 'collections.sample'),
  extractApi('collections', 'sliding_windows', 'sliding_windows', 'collections.sliding_windows'),
  extractApi('collections', 'sort_by', 'sort_by', 'collections.sort_by'),
  extractApi('collections', 'sum_of', 'sum_of', 'collections.sum_of'),
  extractApi('collections', 'take_last_while', 'take_last_while', 'collections.take_last_while'),
  extractApi('collections', 'take_while', 'take_while', 'collections.take_while'),
  extractApi('collections', 'union', 'union', 'collections.union'),
  extractApi('collections', 'unzip', 'unzip', 'collections.unzip'),
  extractApi('collections', 'without_all', 'without_all', 'collections.without_all'),
